...
class KotlinLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r"'\\.'|'[^\\]'", String.Char),
            # Numbers
            (r"0[xX][0-9a-fA-F]([_0-9a-fA-F]*[0-9a-fA-F])?[uU]?L?|"
             r"0[bB][01]([_01]*[01])?[uU]?L?|"
             r"\.[0-9]([_0-9]*[0-9])?([eE][+-]?[0-9]([_0-9]*[0-9])?)?[fF]?|"
             r"(([0-9]([_0-9]*[0-9])?)(\.[0-9]([_0-9]*[0-9])?)?)(([eE][+-]?[0-9]([_0-9]*[0-9])?)[fF]?|[fF])|"
             r"(0|[1-9]([_0-9]*[0-9])?)([uU]?L?)" , Number),
            # Identifiers
